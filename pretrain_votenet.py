...
parser.add_argument('--log_dir', default='./log_scannet/votenet', help='Dump dir to save model checkpoint [default: log]')
...
if FLAGS.dataset == 'sunrgbd':
    ...
    TRAIN_DATASET = SunrgbdDetectionVotesDataset('train',
        labeled_ratio=FLAGS.labeled_ratio, labeled_sample_list=FLAGS.labeled_sample_list,
